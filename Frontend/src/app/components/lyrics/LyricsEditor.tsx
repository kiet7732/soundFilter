...
export function LyricsEditor({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative bg-white/5 backdrop-blur-md border border-white/10 transition-all duration-300 ${
          isExpanded
      ...
      >
        ...
        <div
          className={`space-y-3 ${
            isExpanded ? "overflow-y-auto flex-1 pr-2" : "max-h-96 overflow-y-auto"
          }`}
        >
          {lyrics.map((line) => (
            <div
